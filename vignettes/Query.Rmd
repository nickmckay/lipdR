...
```{r}
qt <- queryLipdverse(pub.info = c("10.1029/2008PA0016718K7NFLXQ1"))
```
...
```{r}
qt <- queryLipdverse(compilation = c("wNAm"), grab.data = FALSE)
```

or multiple compilations

```{r}
qt <- queryLipdverse(compilation = c("wnam", "temp12k"), grab.data = FALSE)
```
